...
Object.defineProperty(exports, "MediaCategory", { enumerable: true, get: function () { return types_2.MediaCategory; } });
Object.defineProperty(exports, "NonScoreWeightName", { enumerable: true, get: function () { return types_2.NonScoreWeightName; } });
Object.defineProperty(exports, "ScoreName", { enumerable: true, get: function () { return types_2.ScoreName; } });
// Strings
...
class TheAlgorithm {
    ...
    weightInfo = this.weightedScorers.reduce((scorerInfos, scorer) => {
        ...
        return scorerInfos;
    }, Object.values(types_2.NonScoreWeightName).reduce((nonScoreWeights, weightName) => {
    ...
    async triggerFeedUpdate(moreOldToots) {
        ...
        dataLoads = dataLoads.concat([
            this.fetchAndMergeToots(toots_for_tags_list_1.default.getToots(types_2.CacheKey.FAVOURITED_HASHTAG_TOOTS), types_2.CacheKey.FAVOURITED_HASHTAG_TOOTS),
            this.fetchAndMergeToots(toots_for_tags_list_1.default.getToots(types_2.CacheKey.PARTICIPATED_TAG_TOOTS), types_2.CacheKey.PARTICIPATED_TAG_TOOTS),
            this.fetchAndMergeToots(toots_for_tags_list_1.default.getToots(types_2.CacheKey.TRENDING_TAG_TOOTS), types_2.CacheKey.TRENDING_TAG_TOOTS),
            this.fetchAndMergeToots(mastodon_server_1.default.fediverseTrendingToots(), types_2.CacheKey.FEDIVERSE_TRENDING_TOOTS),
    ...
    async loadCachedData() {
        this.feed = await Storage_1.default.getCoerced(types_2.CacheKey.TIMELINE_TOOTS);
        this.homeFeed = await Storage_1.default.getCoerced(types_2.CacheKey.HOME_TIMELINE_TOOTS);
    ...
    async scoreAndFilterFeed() {
        ...
        await Storage_1.default.set(types_2.CacheKey.TIMELINE_TOOTS, this.feed);
        return this.filterFeedAndSetInApp();
    }
