...
class TheAlgorithm {
    ...
    async mergeTootsIntoFeed(tootFetcher) {
        ...
        try {
            ...
            await this.scoreAndFilterFeed();
            (0, log_helpers_1.logInfo)(logPrefix, `${string_helpers_1.TELEMETRY} retrieved + merged ${logTootsStr()}, state:`, this.statusDict());
            return newToots;
        }
        finally {
            releaseMutex();
