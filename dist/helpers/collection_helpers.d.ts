 ...
 * a dict of results keyed by input. Raises error on {@linkcode api_errors.isAccessTokenRevokedError},
 ...
 */
export declare function zipPromiseCalls<T>(args: string[], promiser: (s: string) => Promise<T>, logger?: Logger): Promise<Record<string, T>>;
export {};
