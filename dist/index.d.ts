...
import { FeedFilterSettings, KeysOfValueType, MastodonInstances, MastodonTag, MediaCategory, MinMaxAvg, NonScoreWeightName, ScoreName, ScoreStats, StringNumberDict, TagWithUsageCounts, TrendingLink, TrendingObj, TrendingStorage, TrendingWithHistory, WeightName, Weights, WeightInfoDict } from "./types";
