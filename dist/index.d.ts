...
declare class TheAlgorithm {
    ...
    featureScorers: (ChaosFeatureScorer | FavsFeatureScorer | FollowedTagsFeatureScorer | ImageAttachmentScorer | InteractionsFeatureScorer | NumFavoritesScorer | NumRepliesScorer | NumRetootsScorer | RetootedUsersScorer | RepliedFeatureScorer | TrendingTootFeatureScorer | TrendingTagsFeatureScorer | VideoAttachmentScorer)[];
