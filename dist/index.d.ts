...
import { FeedFilterSettings, KeysOfValueType, MastodonInstances, MediaCategory, NonScoreWeight, WeightInfoDict, StringNumberDict, TagWithUsageCounts, TrendingLink, TrendingObj, TrendingStorage, TrendingWithHistory, WeightName, Weights, MastodonTag } from "./types";
