...
export declare function uniquifyTrendingObjs<T extends TrendingWithHistory>(trendingObjs: TrendingWithHistory[], uniqueKey: (obj: TrendingWithHistory) => string): T[];
