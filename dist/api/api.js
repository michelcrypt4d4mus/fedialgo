...
class MastoApi {
    ...
    async fetchHomeFeed(numToots, maxId) {
        ...
        (0, log_helpers_1.traceLog)(`${logPrefix} Built ${toots.length} toots ${(0, time_helpers_1.ageString)(startedAt)} (oldest: ${(0, time_helpers_1.quotedISOFmt)((0, toot_1.earliestTootedAt)(toots))})`);
        return toots;
    }
    ;
